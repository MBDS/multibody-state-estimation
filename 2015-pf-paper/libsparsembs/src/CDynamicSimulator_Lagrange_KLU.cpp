...
//  Solver: (Sparse) KLU
// ---------------------------------------------------------------------------------------------
CDynamicSimulator_Lagrange_KLU::CDynamicSimulator_Lagrange_KLU(const CAssembledRigidModelPtr arm_ptr)
	:
...
void CDynamicSimulator_Lagrange_KLU::internal_solve_ddotq(double t, VectorXd & ddot_q, VectorXd * lagrangre )
{
