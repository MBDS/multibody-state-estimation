...
//  Solver: Dense LU
// ---------------------------------------------------------------------------------------------
CDynamicSimulator_Lagrange_LU_dense::CDynamicSimulator_Lagrange_LU_dense(const CAssembledRigidModelPtr arm_ptr)
...
void CDynamicSimulator_Lagrange_LU_dense::internal_solve_ddotq(double t, VectorXd & ddot_q, VectorXd * lagrangre )
{
