...
void sparsembs::buildParameterizedMBS(
...
void sparsembs::buildLongStringMBS(const size_t N, CModelDefinition& model)
{
	ASSERT_(N >= 1);
...
void sparsembs::buildFourBarsMBS(CModelDefinition& model)
{
...
void sparsembs::buildSliderCrankMBS(CModelDefinition& model)
{
...
void sparsembs::buildFollowerMBS(CModelDefinition& model)
{
...
void sparsembs::buildTwoSliderBlocks(CModelDefinition& model)
{
