...
/* -------------------------------------------------------------------
   ...
   -------------------------------------------------------------------*/
void ConstraintFixedSlider::buildSparseStructures(
...
void ConstraintFixedSlider::update(AssembledRigidModel& arm) const
{
 ...
 */
bool ConstraintFixedSlider::get3DRepresentation(
